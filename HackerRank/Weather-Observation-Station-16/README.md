...
Query the smallest Northern Latitude (LAT_N) from STATION that is greater than . Round your answer to  decimal places.Input 
...
*/
select round(min(lat_n),4) from (select lat_n from station where lat_n > 38.7780) b;
